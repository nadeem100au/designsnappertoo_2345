                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div 
                          ...
                          className={`p-4 rounded-xl border-2 cursor-pointer transition-all relative overflow-hidden ${
                            analysisMode === 'with-influencer' ? 'border-[#0066ff] bg-[#0066ff]/5' : 'border-slate-100 hover:border-slate-300'
                          }`}
                        >
                          <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {[
                            ...
                            <div key={persona.id} onClick={() => setSelectedPersona(persona.id)} className={`relative p-3 rounded-xl border-2 cursor-pointer transition-all flex flex-col gap-3 ${selectedPersona === persona.id ? 'border-[#0066ff] bg-[#0066ff]/5 shadow-md scale-[1.02]' : 'border-slate-100 hover:border-slate-200 bg-white'}`}>
                               ...
                               <div className="flex items-center justify-between">
                                  ...
                                  {selectedPersona === persona.id && <CheckCircle2 className="w-4 h-4 text-[#0066ff]" />}
                               </div>
                            </div>
                          ))}
                        </div>
                ...
                <>
                  ...
                  <div className="w-full max-w-2xl bg-white border-2 border-slate-100 rounded-[32px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] p-8 flex flex-col gap-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea 
                        className="w-full h-24 p-4 text-sm font-medium text-slate-900 placeholder:text-slate-400 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0066ff]/20 focus:border-[#0066ff] transition-all resize-none"
